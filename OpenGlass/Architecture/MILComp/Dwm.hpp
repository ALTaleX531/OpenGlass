...
namespace OpenGlass::dwmcore
{
	...
	{
		inline HRESULT CombinedGeometryUpdate(
			UINT handleId,
		...
		{
			OPENGLASS_MUSTTAIL return Projection::Invoke<&CChannel::CombinedGeometryUpdate>(this, handleId, mode, geometry1HandleId, geometry2HandleId);
		}
	};
}
