...
namespace OpenGlass
{
	...
	{
		inline HRESULT GetVisualCollection(abi::IVisualCollection** collection)
		{
			return std::invoke(
	...
	{
		inline HRESULT CreateSharedResource(REFIID riid, PVOID* ppvObject)
		{
			return std::invoke(
		...
		inline HRESULT OpenSharedResourceHandle(IUnknown* unknown, HANDLE* resourceHandle)
		{
			return std::invoke(
